            ...
            <div className='w-full'>
                <div className='flex justify-between gap-5 lg:gap-10 overflow-x-auto pb-10 pr-20'>
                    {testimonials.map((data, i)=>{
                        return (
                            <div key={i} className='md:h-[60vh] h-[50vh] min-w-[75vw] md:min-w-[50vw] lg:min-w-[40vw] xl:min-w-[30vw] bg-bglightpurple relative p-5 pl-10 pt-10 lg:p-20 rounded-tr-[75px] lg:rounded-tr-[150px] flex flex-col justify-between'>

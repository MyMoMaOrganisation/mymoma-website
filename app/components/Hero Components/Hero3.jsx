...
const Hero3 = () => {
    return (
            <div className=" min-h-[97.5vh] w-full bg-[#5EC0C9] rounded-b-[35px] relative flex flex-col py-40 lg:py-0 lg:justify-center px-5 lg:px-20 xl:px-40 text-[#5EC0C9]">
                <Text />
                ...
                <Image src={hero3} alt="hero image" className=" absolute right-0 bottom-0 rounded-b-[35px]" />
            </div>
    );
}

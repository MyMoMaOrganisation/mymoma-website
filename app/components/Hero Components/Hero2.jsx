...
const Hero2 = () => {
    return (
            <div className=" min-h-[97.5vh] w-full bg-[#1E1EF4] rounded-b-[35px] relative flex flex-col py-40 lg:py-0 lg:justify-center px-5 lg:px-20 xl:px-40 text-[#1E1EF4]">
                <Text />
                ...
                <Image src={hero2} alt="hero image" className=" absolute right-0 bottom-0 rounded-b-[35px]" />
            </div>
    );
}
